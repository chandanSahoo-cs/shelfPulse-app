          ...
          <div className="bg-blue-50 border-4 border-gray-900 p-6 shadow-[4px_4px_0px_0px_#1f2937]">
            ...
            <Button
              ...
              {isLoading ? (
                ...
                <>
                  <SearchIcon className="size-6" /> LOOKUP PRODUCT
                </>
              )}
            </Button>
          </div>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-white border-4 border-gray-900 p-6 shadow-[4px_4px_0px_0px_#1f2937]">
                  ...
                  <div className="text-3xl font-black text-red-600">
                    {result.prediction.days_to_expiry_pred} DAYS
                  </div>
                ...
                <div className="bg-white border-4 border-gray-900 p-6 shadow-[4px_4px_0px_0px_#1f2937]">
                  ...
                  <div
                    className={`flex items-center gap-2 text-white font-black px-3 py-2 ${getRiskColor(
                      result.prediction.spoilage_risk
                    )}`}>
                  ...
                  <div className="text-sm font-bold text-gray-600 mt-2">
                    Score:{" "}
                    {(result.features.Spoilage_Risk_Score * 100).toFixed(1)}%
                  </div>
                </div>
                ...
                <div className="bg-white border-4 border-gray-900 p-6 shadow-[4px_4px_0px_0px_#1f2937]">
                  ...
                  <div
                    className={`flex items-center gap-2 text-white font-black px-3 py-2 ${getRiskColor(
                      result.prediction.sustainability_label
                    )}`}>
                  ...
                  <div className="text-sm font-bold text-gray-600 mt-2">
                    Recyclability:{" "}
                    {(result.features.Recyclability_Score * 100).toFixed(1)}%
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                {result.prediction.dead_stock && (
                  <Badge className="bg-red-600 text-white font-bold border-3 border-gray-900 text-lg px-4 py-2 flex gap-2">
                    <AlertTriangleIcon className="size-6" /> DEAD STOCK
                  </Badge>
                )}
                {result.prediction.trigger_markdown && (
                  <Badge className="bg-amber-500 text-white font-bold border-3 border-gray-900 text-lg px-4 py-2 flex gap-2">
                    <FaTag className="size-6" /> MARKDOWN TRIGGER
                  </Badge>
                )}
                {result.prediction.suggested_markdown_percent > 0 && (
                  <Badge className="bg-yellow-500 text-gray-900 font-bold border-3 border-gray-900 text-lg px-4 py-2 flex gap-2">
                ...
                {result.features.Take_Back_Eligible === 1 && (
                  <Badge className="bg-green-600 text-white font-bold border-3 border-gray-900 text-lg px-4 py-2">
                    <RecycleIcon className="size-6" /> TAKE-BACK ELIGIBLE
                  </Badge>
                )}
              </div>
                ...
                <div className="bg-blue-50 border-4 border-gray-900 p-6 shadow-[4px_4px_0px_0px_#1f2937]">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          result.features.Average_Turnover_Time / 30
                        )}`}>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          result.features.Days_Since_Last_Sale / 30
                        )}`}>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          1 - result.features.Historical_Sell_Through
                        )}`}>
                        {(
                          result.features.Historical_Sell_Through * 100
                        ).toFixed(1)}
                        %
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          result.features.Markdown_History / 5
                        )}`}>
                ...
                <div className="bg-amber-50 border-4 border-gray-900 p-6 shadow-[4px_4px_0px_0px_#1f2937]">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          result.features.Overstock_Risk
                        )}`}>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          result.features.Waste_Risk_Index
                        )}`}>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          result.features.Sensor_Anomalies / 10
                        )}`}>
                ...
                <div className="bg-green-50 border-4 border-gray-900 p-6 shadow-[4px_4px_0px_0px_#1f2937]">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          result.features.Embedded_Carbon_Footprint / 10
                        )}`}>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          result.features.Transport_Emissions / 10
                        )}`}>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          1 - result.features.Compostability_Score
                        )}`}>
                        {(result.features.Compostability_Score * 100).toFixed(
                          1
                        )}
                        %
                      </span>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-black ${getScoreColor(
                          1 - result.features.Recycled_Content_Pct
                        )}`}>
                        {(result.features.Recycled_Content_Pct * 100).toFixed(
                          1
                        )}
                        %
                      </span>
